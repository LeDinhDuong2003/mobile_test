...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseViewHolder holder, int position) {
        ...
        // Set card background color based on position (alternating colors)
        if (position % 2 == 0) {
            holder.cardView.setCardBackgroundColor(context.getResources().getColor(R.color.course_pink));
        } else {
            holder.cardView.setCardBackgroundColor(context.getResources().getColor(R.color.course_orange));
        }

        // Load course image from URL using Glide
        Glide.with(context)
        ...
        // Set best seller badge visibility
